...
3. Post Process pre/post: static single-input-pose isolation and live same-instance PoseWatch capture are complete for the two variants. A separate `sample_postprocess_pre_post_pose` command is no longer needed for these fixtures.
