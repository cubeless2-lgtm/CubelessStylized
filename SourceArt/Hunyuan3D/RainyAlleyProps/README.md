...
- Use the working script under `<CubelessStylized>/Saved/Codex/generate_keilan_hunyuan3d_textures_1k_from_manifest.py` for future accepted-shape texture generation.
