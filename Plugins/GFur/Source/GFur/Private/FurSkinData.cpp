...
// FBoneMatricesUniformShaderParameters was removed in UE 5.7; define locally for the
// pre-ES3.1 fallback path (dead code on UE 5.7 since all platforms require ES3.1+)
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FBoneMatricesUniformShaderParameters, )
	SHADER_PARAMETER_ARRAY(FVector4f, BoneMatrices, [1536])
